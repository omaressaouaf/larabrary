    ...
    <section class="content" >
      ...
      <div class="card shadow">
        <div class="card-header bg-white border-0">
          <div class="row align-items-center">
            ...
            <div class="col-4 text-right">
              <router-link :to="{name : 'books'}" class="btn btn-sm btn-warning">
        ...
        <div class="card-body">
          ...
          <form v-else @submit.prevent="updateBook(bookObject)">
            ...
            <div class="pl-lg-4">
              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="form-group">
                    ...
                    <div v-if="bookObject.genres.length" class="form-group focused mt-2">
                      <span
                        :key="genre.id"
                    ...
                    <div
                      v-if="bookObject.errors.has('genres') && bookObject.genres.length ==0"
                      class="alert alert-danger mt-3"
                    >
                      <span class>
                        <i class="fa fa-exclamation-triangle"></i> No Genres Assigned ! Pick at least one
                      </span>
                    </div>
                  </div>
                </div>
                <div class="col-lg-6">
                  <div class="form-group">
                    ...
                    <select
                      :class="{'is-invalid':bookObject.errors.has('user_id')}"
                      class="form-control"
              ...
              <div class="row">
                <div class="col-lg-12">
                  <div class="form-group">
                    ...
                    <div v-if="newImagesHaveErrors" class="alert alert-danger mt-3">
                      <span class>
                        <i class="fa fa-exclamation-triangle"></i> Selected Files should be images (jpg ,jpeg , png ) and they should not exceed 9mb
                      </span>
                    </div>
                  </div>
                </div>
              ...
              <div class="row">
                <div class="col-lg-12">
                  <div class="form-group">
                    <h5 class="lead" v-if="urls.length">New Images</h5>
                    <span v-for="(image,index) in urls" :key="index">
                      <img class="img-fluid" :src="image" width="80" height="80" alt="no Image" />
                      <button
                        type="button"
                  ...
                  <div class="form-group">
                    <h5 class="lead" v-if="bookObject.images.length">Old Images</h5>
                    <span v-for="image in bookObject.images" :key="image.id">
                      <img class="img-fluid" :src="image.name" width="80" height="80" alt />
                      <button
                        type="button"
                ...
                <div class="col-lg-12">
                  <div class="form-group">
                    ...
                    <textarea
                      rows="4"
                      class="form-control form-control-alternative"
                      :class="{'is-invalid':bookObject.errors.has('description')}"
                      v-model="bookObject.description"
                      placeholder="A small description about The Book ..."
                    ></textarea>
                    <has-error :form="bookObject" field="description"></has-error>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="form-group col-lg-12">
                  <button type="submit" class="btn btn-primary btn-block submitBook">
                    <i class="fa fa-check"></i> Save Book
                  </button>
                </div>
              </div>
            </div>
...
export default {
  ...
  methods: {
    removeOldFile(deletedImg) {
      this.bookObject.images = this.bookObject.images.filter(
        (image) => image.id !== deletedImg.id
      );
      this.deletedImages.push(deletedImg);
      this.bookObject["deletedImages"] = this.deletedImages;
    },
    removeNewFile(index) {
    ...
    ...mapActions('books',["fetchBook", "fetchGenres", "fetchAuthors", "updateBook"]),
  },
  mounted() {
    this.fetchGenres();
    this.fetchAuthors();
