...
<style>
    ...
    .profile-cover__action {
        ...
        overflow: hidden;
        background: url('/storage/images/design/random/dashboard-bg.jpg') no-repeat;
        /* https://bootdey.com/img/Content/bg1.jpg */
...
<div aria-label="breadcrumb " class="breadcrumb py-1 " style="margin-top: 92px">
    ...
    <div class="container">
        ...
        <ol class="breadcrumb breadcrumb-nav">
            ...
            <li class="breadcrumb-item "><a href="{{route('authors')}}">Our Authors</a></li>
            <li class="breadcrumb-item active" aria-current="page">{{$author->id}}</li>
    ...
    <div class="col-lg-12">
        <div class="panel profile-cover">
            ...
            <div class="profile-cover__info">
                <ul class="nav">
                    <li><strong>{{$author->books->count()}}</strong>Books</li>
                    <li><strong>{{$authorSalesCount}}</strong>Sales</li>
                </ul>
            </div>
        </div>
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title">Author's Work</h3>
            </div>
            <div class="panel-content panel-activity">
                <h4 class="lead mb-4">About me</h4>
                <div class="alert alert-primary mb-4" style="border-radius: 0%">
                    {{$author->bio}} <br><br>
                    Contact me at : <span class="lead">{{$author->email}}</span>
                </div>
                <h4 class="lead mb-4 ">My Books</h4>
                ...
                <div class="card p-3 mb-4">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-8">
                            ...
                            <small class="lead display-6"><i class="fa fa-clock-o" aria-hidden="true"></i> Posted On
                                {{Carbon\Carbon::parse($book->created_at)->format('Y D m')}}</small>
                        </div>
                        <div class="col-md-2">
                            <a href="{{route('library.show',$book->slug)}}" class="btn btn-primary float-right">
                                Details</a>
                        </div>
                    </div>
                ...
                <div class="alert alert-warning" role="alert">
                    ...
                    <p>I Dont Have Any books posted at the moment Sorry.</p>
